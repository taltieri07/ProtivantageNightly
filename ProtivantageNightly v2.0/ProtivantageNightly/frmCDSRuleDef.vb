...
Public Class frmCDSRuleDef
    ...
    Private Sub frmCDSRuleDef_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.RuleDatagrid.Columns(8).ReadOnly = False
    ...
    Private Sub btnSaveRule_Click(sender As System.Object, e As System.EventArgs) Handles btnSaveRule.Click
        ...
        SelectString = "INSERT INTO tblDosingAlgorithm([Priority], [ReasonForTherapy], [INRLowerLimit], [INRUpperLimit], [IncDec], [PercentageChange], " & _
            "[VarianceAllowed], [Comment], [Inactive]) VALUES ('" & Me.txtPriority.Text & "', '" & Me.cmbReasonForTherapy.Text & "', '" & Me.cmbRelational1.Text & " " & Me.txtINRcompare1.Text & _
            "', '" & Me.cmbRelational2.Text & " " & Me.txtINRcompare2.Text & "', '" & Me.cmbChange.Text & "', " & PercentChange & ", " & Me.txtVariance.Text & ", '" & Me.txtComment.Text & "', 0);"
        MsgBox(SelectString)
